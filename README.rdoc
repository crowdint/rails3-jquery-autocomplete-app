...
This will include the gem as a dependency for the application.

Then, make sure you have the gem installed by running:
...
Copy the files on the _js_ folder to the public/javascripts folder on your app.

Copy the files on the _css_ folder to the public/stylesheets folder on your app.
